...
```r
options(frame.rows = 5L) # truncate output after 5 rows
```
...
```
## Error in match("day", names(x)): object 'x' not found
```
...
```
##   year month day dep_time sched_dep_time dep_delay arr_time …
## 1 2013     8  24      547            545         2      816 …
## 2 2013    12   7     1447           1445         2     1842 …
## 3 2013     2  17      809            810        -1     1024 …
## 4 2013     4  30     1354           1359        -5     1447 …
## 5 2013     8  28      905            910        -5     1203 …
